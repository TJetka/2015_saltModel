#load(file="data/premodel_final.RData")
load(file="data/model_initial.RData")
...
# model_in_var$reference_salt=5
# model_in_var$current_salt=9.6
...
# 
# campaign_cost_annualy <- c(rep(model_in_var$campaign_cost1,5),rep(model_in_var$campaign_cost2, length(comparison_direct)-5 ))
# ## Comparisons
# 
# ##TUTAJ##
...
#write.table(data.frame(comp_out),file=paste("Data/Output/Output_",model_in_var$reference_sodium,"_",model_in_var$current_sodium,".txt",sep=""),col.names=TRUE)
